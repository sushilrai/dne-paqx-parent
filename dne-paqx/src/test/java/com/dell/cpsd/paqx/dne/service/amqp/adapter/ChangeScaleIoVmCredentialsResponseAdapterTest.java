...
public class ChangeScaleIoVmCredentialsResponseAdapterTest
        extends BaseAsynchronousResponseAdapterTest<RemoteCommandExecutionResponseMessage>
{
    @Override
    ...
    {
        return new ChangeScaleIoVmCredentialsResponseAdapter(this.registry, this.runtimeService);
    }
