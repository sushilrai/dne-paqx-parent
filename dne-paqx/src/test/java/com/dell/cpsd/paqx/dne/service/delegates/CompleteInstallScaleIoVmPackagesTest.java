...
public class CompleteInstallScaleIoVmPackagesTest
{
    ...
    public void testSuccess() throws Exception
    {
        doReturn(RemoteCommandExecutionResponseMessage.Status.SUCCESS).when(asynchronousNodeService)
                .processInstallScaleioVmPackages(asynchronousNodeServiceCallback);
    ...
    {
        doReturn(RemoteCommandExecutionResponseMessage.Status.FAILED).when(asynchronousNodeService).processInstallScaleioVmPackages(asynchronousNodeServiceCallback);
        try
        {
            completeInstallScaleIoVmPackages.delegateExecute(delegateExecution);
        }
