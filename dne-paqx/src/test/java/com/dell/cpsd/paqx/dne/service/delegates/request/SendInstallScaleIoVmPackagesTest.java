...
public class SendInstallScaleIoVmPackagesTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        doReturn(asynchronousNodeServiceCallback).when(asynchronousNodeService).sendInstallScaleIoVmPackages(any(), any(), any(), any());
    ...
    public void delegateExecuteRequestUnsuccessful() throws Exception
    {
        ...
        doReturn(null).when(asynchronousNodeService).sendInstallScaleIoVmPackages(any(), any(), any(), any());
        try
        {
    ...
    public void delegateRequestException()  throws Exception
    {
        ...
        doThrow(new TaskResponseFailureException(1, errorMessage)).when(asynchronousNodeService)
                .sendInstallScaleIoVmPackages(any(), any(), any(), any());
