...
public class PerformanceTuneScaleIoVmResponseAdapterTest extends BaseAsynchronousResponseAdapterTest<RemoteCommandExecutionResponseMessage>
{
    @Override
    ...
    {
        return new PerformanceTuneScaleIoVmResponseAdapter(this.registry, this.runtimeService);
    }
